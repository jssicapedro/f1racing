            ...
            <div class="item">
                ...
                <div class="item-content">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="fullName" name="fullName" value="{{ $team->fullName }}" required>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="item-content">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="base" name="base" value="{{ $team->base }}" required>
                    </div>
                </div>
                <div class="item-content">
                    <div class="mb-3">
            ...
            <div class="item">
                <div class="item-content">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="teamChief" name="teamChief" value="{{ $team->teamChief }}" required>
                    </div>
                </div>
                <div class="item-content">
                    <div class="mb-3">
                        <label for="technicalChief" class="form-label">Technical Chief</label>
                        <input type="text" class="form-control" id="technicalChief" name="technicalChief" value="{{ $team->technicalChief }}" required>
                    </div>
                </div>
                <div class="item-content">
                    <div class="mb-3">
                        <label for="firstTeamEntry" class="form-label">First Year</label>
                        <input type="text" class="form-control" id="firstTeamEntry" name="firstTeamEntry" value="{{ $team->firstTeamEntry }}" required>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="item-content">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="polePositions" name="polePositions" value="{{ $team->polePositions }}" required>
                    </div>
                </div>
                <div class="item-content">
                    <div class="mb-3">
                        <label for="worldChampionShips" class="form-label">World Champions Ships</label>
                        <input type="number" class="form-control" id="worldChampionShips" name="worldChampionShips" value="{{ $team->worldChampionShips }}" required>
                    </div>
                </div>
                <div class="item-content">
                    <div class="mb-3">
                        <label for="color" class="form-label">Color</label>
                        <input type="color" class="form-control" id="color" name="color" value="{{ $team->color }}" required>
                    </div>
                </div>
            </div>
            <div class="title">
