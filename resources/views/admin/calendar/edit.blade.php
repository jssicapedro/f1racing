...
<script>
    var formToSubmit = null; // Global variable to store the form to be submitted

    function showConfirmDeleteModal(event) {
        event.preventDefault(); // Prevent the default link behavior

        formToSubmit = event.target.closest('form'); // Store the form

        var confirmDeleteModal = new bootstrap.Modal(document.getElementById('confirmDeleteModal'));
        confirmDeleteModal.show(); // Show the confirmation modal
    }

    // Event listener for the delete button in the form
    document.getElementById('deleteButton').addEventListener('click', showConfirmDeleteModal);
